...
class Brain:
    ...
    def _build_model(self):
        ...
        l_input = Input(batch_shape=(None, NUM_STATE[0], NUM_STATE[1], NUM_STATE[2]))

        # Block 1
        x = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv1')(l_input)
        ...
        l_dense = Dense(4096, activation='relu', name='fc1')(x)
    ...
    def _build_graph(self, model):
        s_t = tf.placeholder(tf.float32, shape=(None, NUM_STATE[0], NUM_STATE[1], NUM_STATE[2]))
...
space = env_test.env.observation_space
NUM_STATE = [396, 622, 3]
NUM_ACTIONS = 3 #up, right, left
